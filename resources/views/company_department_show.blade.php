                                    ...
                                    <div class="col-sm-6 col-md-4 col-lg-4 col-xl-3">
                                        ...
                                        <div class="box box-primary">
                                            ...
                                            <div class="box-header with-border">
                                                <h3 class="box-title">
                                                    <!-- urlencode() -->
                                                    <a href="{!! route('department.showDepartmentPDCA', [urlencode($companyObj->company_name), urlencode($department->department_pk)]) !!}">{{ $department->department_pk }}</a>
                                                </h3>
                                          ...
                                          datasets: [
                                            {
                                                ...
                                                data                : [{!! $department->pDCACompanyDepartmentAllCountPercentage !!}],
                                                dataCount      : [{!! $department->pDCACompanyDepartmentAllCount !!}],
                                            ...
                                            options: {
                                                ...
                                                'onClick': function (event, item) {
                                                    ...
                                                    if (activeElement) {
                                                        ...
                                                        var url = "{!! route('department.showDepartmentPDCA', [urlencode($companyObj->company_name), urlencode($department->department_pk)]) !!}";
